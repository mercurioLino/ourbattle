...
@Component({
  selector: 'app-torneio-insert-jogador',
  templateUrl: './torneio-insert-jogador.component.html',
  styleUrls: ['./torneio-insert-jogador.component.scss']
})
export class TorneioInsertJogadorComponent implements OnInit {
  jogadores: Jogador[] = [];
  torneios: Torneio[] = [];
